            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="regForm" action="{{ route('ptournament.jadwal') }}">
                ...
                <div class="singletab tournaments-tab">
                    ...
                    <div class="tabcontents">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <h4>Link Bracket Tournament <button id="openModalBtn" class="btn btn-outline-light"><i
                                        class="ti ti-plus"></i>New</button></h4>
                            ...
                            <div id="linksContainer" class="container">
                                <!-- Tempat untuk menampilkan link-link yang dimasukkan -->
                            </div>
                        </div>
