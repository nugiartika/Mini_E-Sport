                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide" style="border: 5px solid rgb(0, 0, 0);"> <!-- Menambahkan border solid hitam dengan lebar 12px -->
                        <div class="card-3d d-grid justify-content-center p-3">
                            ...
                            <h5 class="card-title text-center tcn-1 mb-4 title-anim">1 Win Team</h5>
                            <h5 class="card-title text-center tcn-1 mb-4 title-anim">2 Win Team</h5>
                            <h5 class="card-title text-center tcn-1 mb-4 title-anim">3 Win Team</h5>
                        </div>
                    </div>
                </div>
            </div>
