                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a type="button" class="btn btn-primary" data-toggle="tooltip"
                            ...
                            style="background-color:rgb(40, 144, 204); color:#fff;"><b>Add category</b>
                        </a>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 15%">
                                        <div class="actions-btn">
                                            <button type="button"
                                            class="badge bg-label-warning me-1 border-0"
                                            ...
                                            <form action="{{ route('category.destroy', ['category' => $a->id]) }}" method="POST" style="display:inline">
                                                @csrf
                                                @method('DELETE')
                ...
                <div class="modal-body">
                    <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('membersPerTeam') is-invalid @enderror" id="membersPerTeam" name="membersPerTeam">
                            @error('membersPerTeam')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="modal-body">
                        <form action="{{ route('category.update', $a->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($a->photo)
                                <img src="{{ asset('storage/' . $a->photo) }}" alt="" width="50" height="50">
                                @else
                                No Image
                                @endif
                                @error('photo')
