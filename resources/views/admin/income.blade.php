    ...
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <form action="{{ route('income.index') }}" method="get">
            <div class="input-group mb-3">
                <input type="search" name="search" class="form-control" placeholder="Cari Nama Tournament&hellip;" value="{{ old('search', request('search')) }}" />
            ...
            <div class="col-lg-12">
                <div class="row gy-4 gy-sm-1">
                    <div class="d-flex justify-content-between align-items-start card-widget-1 pb-3 pb-sm-0">
                        <div>
                            <h6 class="mb-2 fs-6">Saldo Admin</h6>
                            <h6 class="mb-2">Rp . {{ number_format($totalIncomeAdmin,2,',','.') }}</h6>
                        </div>
                        <span class="avatar me-sm-4 ms-4 mt-1">
                            <span class="avatar-initial bg-label-secondary rounded"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-coin">
