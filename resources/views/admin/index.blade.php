    ...
    <div class="row">
        ...
        <div class="col-xl-2 col-md-4 col-6 mb-4">
            <a href="{{ route('category.index') }}">
                <div class="card">
                    <div class="card-body">
                        <div class="badge p-2 bg-label-warning mb-2 rounded"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="col-xl-2 col-md-4 col-6 mb-4">
            <div class="card">
                <div class="card-body">
                    <div class="badge p-2 bg-label-secondary mb-2 rounded"><svg xmlns="http://www.w3.org/2000/svg"
                            width="32" height="32" viewBox="0 0 24 24">
                            <path fill="currentColor"
        ...
        <div class="col-xl-2 col-md-4 col-6 mb-4">
            <a href="{{ route('DetailTournament') }}">
                <div class="card">
                    <div class="card-body">
                        <div class="badge p-2 bg-label-primary mb-2 rounded"><svg xmlns="http://www.w3.org/2000/svg"
                                width="32" height="32" viewBox="0 0 24 24">
                                <path fill="currentColor"
